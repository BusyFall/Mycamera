...
public class CameraUtils {
    ...
    public static Camera.Size findBestPictureResolution(Camera cameraInst, Activity activity) {
...
//                + defaultPictureResolution.height);
        ...
        // 移除不符合条件的分辨率
        double screenAspectRatio = (double) activity.getResources().getDisplayMetrics().widthPixels
                / (double)  activity.getResources().getDisplayMetrics().heightPixels;
     ...
     * @return
     */
    public static Camera.Size findBestPreviewResolution(Camera cameraInst, Activity activity) {
        Camera.Parameters cameraParameters = cameraInst.getParameters();
...
//        Log.v(TAG, "Supported preview resolutions: " + previewResolutionSb);
        ...
        while (it.hasNext()) {
            ...
            if (maybeFlippedWidth ==(double) activity.getResources().getDisplayMetrics().widthPixels
                    / (double)  activity.getResources().getDisplayMetrics().heightPixels) {
